...
/*****************iriscontacts cpt*********/
function iriscontacts_post_type() {
	$iriscontacts_labels = array(
		'name'                  => _x( 'IRIS Contacts', 'Post Type General Name', 'iris-contacts' ),
		'singular_name'         => _x( 'IRIS Contacts', 'Post Type Singular Name', 'iris-contacts' ),
		'menu_name'             => __( 'IRIS Contacts', 'iris-contacts' ),
		'name_admin_bar'        => __( 'IRIS Contacts', 'iris-contacts' ),
		'archives'              => __( 'Item Archives', 'iris-contacts' ),
		'parent_item_colon'     => __( 'Parent Item:', 'iris-contacts' ),
		'all_items'             => __( 'All Contacts', 'iris-contacts' ),
		'add_new_item'          => __( 'Add New IRIS Contacts', 'iris-contacts' ),
		'add_new'               => __( 'Add New', 'iris-contacts' ),
		'new_item'              => __( 'New Item', 'iris-contacts' ),
		'edit_item'             => __( 'Edit Item', 'iris-contacts' ),
		'update_item'           => __( 'Update Item', 'iris-contacts' ),
		'view_item'             => __( 'View Item', 'iris-contacts' ),
		'search_items'          => __( 'Search Item', 'iris-contacts' ),
		'not_found'             => __( 'Not found', 'iris-contacts' ),
		'not_found_in_trash'    => __( 'Not found in Trash', 'iris-contacts' ),
		'featured_image'        => __( 'Featured Image', 'iris-contacts' ),
		'set_featured_image'    => __( 'Set featured image', 'iris-contacts' ),
		'remove_featured_image' => __( 'Remove featured image', 'iris-contacts' ),
		'use_featured_image'    => __( 'Use as featured image', 'iris-contacts' ),
		'insert_into_item'      => __( 'Insert into item', 'iris-contacts' ),
		'uploaded_to_this_item' => __( 'Uploaded to this item', 'iris-contacts' ),
		'items_list'            => __( 'Items list', 'iris-contacts' ),
		'items_list_navigation' => __( 'Items list navigation', 'iris-contacts' ),
		'filter_items_list'     => __( 'Filter items list', 'iris-contacts' ),
	);
	$iriscontacts_args = array(
		'label'                 => __( 'IRIS Contacts', 'iris-contacts' ),
		'description'           => __( 'IRIS Contacts information page.', 'iris-contacts' ),
		'labels'                => $iriscontacts_labels,
	...
	register_post_type( 'iriscontacts', $iriscontacts_args );
}
add_action( 'init', 'iriscontacts_post_type', 0 );
/*
|===================================================================================|
|																					|
 ...
 */
// Add the Meta Box
function add_iriscontacts_meta_box() {
    add_meta_box(
        'custom_meta_box', // $id
        'Details', // $title 
        'show_iriscontacts_meta_box', // $callback
        'iriscontacts', // $page
        'normal', // $context
        'high'); // $priority
}
add_action('add_meta_boxes', 'add_iriscontacts_meta_box');
 // Field Array
$contact_prefix = 'iriscontacts_';
$custom_iriscontacts_meta_fields_options = array(
...
/*	array(
        'label'=> 'First Name',
        'desc'  => '',
        'id'    => $contact_prefix.'first_name',
        'type'  => 'text'
    ),
	array(
        'label'=> 'Middle Name',
        'desc'  => '',
        'id'    => $contact_prefix.'middle_name',
        'type'  => 'text'
    ),
	array(
        'label'=> 'Last Name',
        'desc'  => '',
        'id'    => $contact_prefix.'last_name',
        'type'  => 'text'
    ),*/
    array(
        'label'=> 'Full Name',
...
array(
	...
	array(
		...
		'options'=> array('select'=>'','Primary Contact'=>'Primary Contact','Secondary Contact'=>'Secondary Contact','Emergency Contact'=>'Emergency Contact','Third Contact'=>'Third Contact','Fourth Contact'=>'Fourth Contact','Fifth Contact'=>'Fifth Contact',),
        'type'  => 'select'
    ),
	...
	array(
		...
		'options'=> array('Father'=>'Father', 'Mother'=>'Mother', 'Husband'=>'Husband', 'Wife'=>'Wife', 'Grandparent'=>'Grandparent', 'Guardian'=>'Guardian', 'Stepfather'=>'Stepfather', 'Stepmother'=>'Stepmother', 'Son'=>'Son', 'Daughter'=>'Daughter', 'Grandson'=>'Grandson', 'Granddaughter'=>'Granddaughter', 'OtherRelative'=>'OtherRelative', 'Friend'=>'Friend',),
        'type'  => 'select'
    ),
...
// The Callback
function show_iriscontacts_meta_box() {
    include('styles.php');
    global $custom_iriscontacts_meta_fields_options, $post;
...
$args = new WP_Query(['post_type' => 'irismembers', 'posts_per_page' => -1 , 'post_status' => 'publish' ]);
 ...
 //exit;
    ...
    foreach ($custom_iriscontacts_meta_fields_options as $field) {
...
.images_parent_class{	display: inline-block;}
        </style><?php
break;
case 'text':
...
// Save the Data
function save_iriscontacts_meta($post_id) {
    global $custom_iriscontacts_meta_fields_options;
/*echo '<pre>';
print_r( $custom_iriscontacts_meta_fields_options);
exit;*/
...
add_action('save_post', 'save_iriscontacts_meta');
