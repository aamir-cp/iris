...
function twentynineteen_scripts() {
	...
	wp_enqueue_style( 'bootstrapsty', 'https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css');
	...
	//wp_enqueue_script( 'bootstr', 'https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.3/umd/popper.min.js');
	wp_enqueue_script( 'boot2', 'https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js');
