...
//print_r($_POST);
//exit;  
if(empty($_POST['contact_belongs_to_member']) || empty($_POST['iriscontacts_name']) ||  empty($_POST['iriscontacts_address']) ||  empty($_POST['iriscontacts_city']) ||  empty($_POST['iriscontacts_state'])  ||  empty($_POST['iriscontacts_postal_code'])   ||  empty($_POST['iriscontacts_gender'])  ||  empty($_POST['iriscontacts_email'])  ||  empty($_POST['iriscontacts_home_number'])  ||  empty($_POST['iriscontacts_cell_number'])  ||  empty($_POST['iriscontacts_work_number']) ||  empty($_POST['iriscontacts_contact_type']) ||  empty($_POST['iriscontacts_relationship_to_member'])   ) {    
    echo '0';  /*|| $_POST['iriscontacts_register']  ==""*/
}else{
