...
//print_r($_POST);
//exit;
//if($_POST['irismembers_address'] == ""  || $_POST['irismembers_city'] == ""  || $_POST['irismembers_state'] == ""  || $_POST['irismembers_postal_code'] == ""  || $_POST['irismembers_dob'] == ""  || $_POST['irismembers_gender'] == ""  || 
...
//$_POST['irismembers_race'] == ""  || $_POST['irismembers_language_capability'] == ""  ||  $_POST['sound_sesitivity'] == ""  ||  $_POST['sensitive_to_touch'] == ""  ||  $_POST['sensitive_to_taste'] == ""  || 
...
//$_POST['irismembers_rescue_department_county'] == ""  || $_POST['irismembers_rescue_department_phone'] == "" ) {
//    echo '0';
//}else{
...
if ($post_id) {
    ...
    'irismembers_photo_upload','irismembers_logo');
//print_r($add_fields);
//exit;
